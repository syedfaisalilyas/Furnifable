import 'package:furnifable/app/data/helpers/notification_type.dart';
...
List<NotificationModel> notificationList = [
  NotificationModel(
    ...
    notificationMessage:
        'Great news! Update available for furnifable. Get the latest features and improvements now. Tap ',
    notificationId: '1',
